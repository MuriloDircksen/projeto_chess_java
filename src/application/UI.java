...
public class UI {
    ...
    //caregando cores para uso no git bash apresentação do jogo
    ...
    public static ChessPosition readChessPosition(Scanner sc){
        try {
            ...
            throw new InputMismatchException("Erro lendo a posição da peça, valores válidos de a1 até h8!");
        }
    }
    ...
    private static void printPiece(ChessPiece piece, boolean backGround){
        ...
        else {//definindo cores das peças
